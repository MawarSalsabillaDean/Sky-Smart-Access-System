...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="profile_content">
            <div class="profile">
                ...
                <button type="button" name="logout" id="log_out" class='bx bx-log-out' onclick="location.href='search_vehicle_layout.php?logout=true';"></button>
                </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="search-container">
            <form action="search_vehicles.php" method="GET" style="display: flex; align-items: center;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if (!empty($vehicle['image_path'])): ?>
                                <img src="<?= htmlspecialchars($vehicle['image_path']) ?>" alt="Vehicle Image" style="width: 100px; height: auto;">
                            <?php else: ?>
                                No Image Available
                            <?php endif; ?>
                        </td>
                        <td><?= htmlspecialchars($vehicle['registration_timestamp']) ?></td>
                        <td>
                            <form method="post"  action="update_vehicles.php">
                                <input type="hidden" name="vehicle_id" value="<?= $vehicle['vehicle_id'] ?>"> <!-- Corrected from id to vehicle_id -->
                                <select name="status">
