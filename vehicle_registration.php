...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
        ...
        include 'process_vehicle_registration.php';
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <form id="vehicleForm" action="vehicle_registration.php" method="post" enctype="multipart/form-data">
                ...
                <div class="visitor details">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="model" name="model" placeholder="e.g. Civic RS" required>
                        </div>

                        <div class="input-field">
                            <label for="car_color">Color</label>
                            <input type="text" id="car_color" name="car_color" placeholder="e.g. Black" required>
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="vehicle_type" name="vehicle_type" placeholder="e.g. Car" required>
                        </div>

                        <div class="input-field">
                            <label for="parking_spot">Preferred parking spot (if applicable)</label>
                            <input type="text" id="parking_spot" name="parking_spot" placeholder="e.g. L6-59" required>
                        </div>
                    ...
                    <button class="submitBtn" onclick="submitButton()" type="submit" name="submit" value="Register Vehicle">
    ...
    <script>
        ...
        document.getElementById('file-upload-input').onchange = function (event) {
            ...
            if (file) {
                ...
                document.getElementById('preview').style.display = 'none'; // Hide the preview if no file selected
            }
        };
