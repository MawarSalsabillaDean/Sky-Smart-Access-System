...
$sql = "SELECT v.visitor_id, v.visitor_name, v.phone_number, v.nric, v.vehicle_registration_number, 
        v.company_name, v.number_of_visitors, v.purpose_of_visit, v.date_of_visit, v.time_of_visit, 
        v.registration_timestamp, v.status, v.comments, r.full_name, r.email, r.unit_number
        FROM visitors v
        JOIN resident_account r ON v.resident_id = r.resident_id
        ORDER BY v.registration_timestamp DESC"; // Adding ORDER BY clause here
...
// Update visitor status and comments
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    $updateStmt->execute([$status, $comments, $visitorId]);

    header("Location: visitor_management.php"); // Redirect back to the management page
    exit();
}
?>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="profile_content">
            <div class="profile">
                ...
                <button type="button" name="logout" id="log_out" class='bx bx-log-out' onclick="location.href='visitor_management.php?logout=true';"></button>
                </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="controls">
            ...
            <form action="search_visitors.php" method="GET">
